...
if($_POST['patientpass'] == $_POST['confirmpassword'] ) { 
$patientname = $mysqli->real_escape_string($_POST['patientname']);
$patientemail = $mysqli->real_escape_string($_POST['patientemail']);
$city = $mysqli->real_escape_string($_POST['patientcity']);
$patientpass = md5($_POST['patientpass']);      
        $sql = "INSERT INTO patient (patientname,patientcity , patientemail, patientpass) VALUES ('$patientname','$city','$patientemail','$patientpass')";
        //print_r($sql); exit();
...
<!--End of Tawk.to Script-->
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="Nav" >
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="profile.php"id="id11"class="id11"><span class="glyphicon glyphicon-user"></span> <span><? $_SESSION['docname'] ?></span></a></li>
 ...
 <div class="container">
     ...
     <center><h1 class="qu" style="font-size:62px;padding-top: 300px;color: black; ">Best specialist</h1></center>
          </div>
        <div class="container">
            <div>
    <?php
